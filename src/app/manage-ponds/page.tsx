...
import { Search, PlusCircle, Edit, Trash2, Info } from 'lucide-react';
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="w-[150px] text-right"><Skeleton className="h-5 w-24 ml-auto" /></TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                            ...
                            <div className="flex items-center justify-end gap-2">
                               <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="icon" onClick={() => handleGoToDetail(pond.id)}>
                                    <Info className="h-5 w-5 text-blue-500" />
                                    <span className="sr-only">Detail Kolam</span>
                                  </Button>
                                </TooltipTrigger>
                                <TooltipContent>
                                  <p>Lihat Detail</p>
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="icon" onClick={() => toast({ title: "Fitur 'Edit' belum tersedia."})}>
                                    <Edit className="h-5 w-5 text-yellow-500" />
                                    <span className="sr-only">Edit Kolam</span>
                                  </Button>
                                </TooltipTrigger>
                                <TooltipContent>
                                  <p>Edit Kolam</p>
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="icon" onClick={() => setPondToDelete(pond)}>
                                        <Trash2 className="h-5 w-5 text-red-500" />
                                        <span className="sr-only">Hapus Kolam</span>
                                    </Button>
                                </TooltipTrigger>
                                <TooltipContent>
                                  <p>Hapus Kolam</p>
