...
export const metrics: Metric[] = [
  { id: 'load-power', name: 'Load Power', value: '2.5 kW', icon: Power },
  { id: 'voltage', name: 'Voltage', value: '220 V', icon: Zap },
  { id: 'current', name: 'Current', value: '11.3 A', icon: GaugeCircle },
  { id: 'frequency', name: 'Frequency', value: '50 Hz', icon: Waves },
  { id: 'do', name: 'Dissolved Oxygen', value: '6.8 mg/L', icon: Droplets },
  { id: 'temperature', name: 'Temperature', value: '28.5 °C', icon: Thermometer },
  { id: 'ph', name: 'pH Level', value: '7.2', icon: FlaskConical },
  { id: 'salinity', name: 'Salinity', value: '15 ppt', icon: Scale },
];
